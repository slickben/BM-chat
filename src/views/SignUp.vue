<template>
        <div class="container mx-auto">
            <div class="flex justify-center items-center px-2 py-6 h-full">
                <div class="flex w-full rounded-lg xl:w-3/4 lg:w-11/12 lg:shadow-xl mx-auto">
                    ...
                    <div
                        ...
                        <div class="relative z-10 text-left ">
                            ...
                            <form class="mt-6" action="#" method="POST">
                                ...
                                <button type="submit" 
                                    class="block w-full px-4 py-3 mt-6 font-semibold text-white transition duration-500
                                     ease-in-out transform rounded-lg bg-gradient-to-r from-purple-600 hover:from-purple-300 to-purple-600 
                                     focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 hover:to-purple-600">Log In</button>
                            </form>
