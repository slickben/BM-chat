    ...
    <div class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            ...
            <div class="modal-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50">
                ...
                <span @click="toggleAddRoomFunc" class="text-sm">(Esc)</span>
            </div>
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <p class="text-xl  md:text-2xl font-bold">Add Room</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                let res = this.name.charAt(0)

                console.log({ userId: this.user._id, name: this.name, name: this.name })
                this.socket.emit("createRoom", { userId: this.user._id, name: this.name, user: this.user.username, avatar: this.generateAvatar(res, 'white', this.getRandomColor()) })
